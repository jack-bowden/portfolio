			...
			<html lang='en'>
				<body className={font.className}>
					<ThemeProvider
						...
						defaultTheme='system'
					>
						<div className='min-h-screen h-full relative pb-6 overflow-x-hidden'>
							<div className='absolute inset-0 min-h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.08] bg-grid-black/[0.03]' />

							<main className='min-h-screen overflow-hidden max-w-6xl px-12 sm:px-16 py-4 mx-auto antialiased'>
